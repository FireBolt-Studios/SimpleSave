...
//		newAdvanced.Lines = File.ReadAllLines(advancedFile[0]);
...
//		newReference.Lines = File.ReadAllLines(referenceFile[0]);
//		Reference = newReference;
	...
	void OnGUI ()
	{
		...
		if (GUI.Button(new Rect(5,65,120,20), "Advanced (Code)"))
		{
		...
		{
			InfoScrollPosition = GUI.BeginScrollView(new Rect(125,25,position.width-130,position.height-30),InfoScrollPosition,new Rect(125,25,1500,1500));

			EditorGUI.TextArea(new Rect(125,25,1500,1500),CurrentHelpFile.Contents);
